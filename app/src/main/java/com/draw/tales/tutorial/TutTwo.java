...
public class TutTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_tut_two,container,false);
    }
    ...
    private void simpleSetup(View view) {
        TextView tv1 = (TextView)view.findViewById(R.id.tut_two_main_text);
        TextView tv2 = (TextView)view.findViewById(R.id.tut_two_so_read_text);
